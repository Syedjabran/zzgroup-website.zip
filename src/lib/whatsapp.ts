/**
 * WhatsApp helpers.
 * The business number and message templates match the ZZ Group content spec.
 * Every product-level message includes the SKU so sales can act immediately.
 */
...
export function generalMessage(d: QuoteDetails = {}): string {
  return (
    ...
    `Category: ${d.category ?? "[Insert Category]"}. ` +
