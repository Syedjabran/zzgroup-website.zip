...
export default async function AdminDashboard() {
  ...
  const [published, drafts, categories, gallery, newEnquiries] = await Promise.all([
    ...
    can.manageCatalogue(user) ? count('categories') : 0,
    can.manageCatalogue(user) ? count('gallery_projects') : 0,
  ...
  const cards = [
    ...
    { label: 'Gallery projects', value: gallery, href: '/admin/gallery' },
